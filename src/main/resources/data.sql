...
INSERT INTO `COURSE` (NAME, DESCRIPTION, SEMESTER, TEACHER_ID) VALUES
    ...
    ('JAVA I', 'Introduction to Java programming language, covering syntax, basic concepts, and foundational skills for software development.', 1, 4),
    ('JAVA II', 'Advanced Java concepts, including data structures, GUI development, and network programming, building on the fundamentals learned in Java I.', 2, 4),
    ('C', 'Foundational course in the C programming language, emphasizing procedural programming and system-level development.', 1, 1),
    ('C#', 'Comprehensive introduction to C# programming, focusing on its use in developing Windows applications, web services, and enterprise-level software.', 4, 1),
    ('Assembly', 'Exploration of low-level programming using Assembly language, delving into computer architecture, memory management, and hardware interaction.',1, 1);
